...
class AdminDashboard extends StatefulWidget {
  ...
  const AdminDashboard({Key key, this.token, this.allPositions, this.allShops, this.user}) : super(key: key);
  @override
       ...
       appBar: AppBar(
        ...
        title:  Text('Admin Menu',
                      style: TextStyle(
                          ...
                          actions: [
                             IconButton(
                      icon: Icon(LineAwesomeIcons.bell), onPressed: () async {
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("${widget.allShops.length.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'Montserrat',
                                      fontWeight: FontWeight.bold,
                                      fontSize:
