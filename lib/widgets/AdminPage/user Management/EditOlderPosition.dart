...
class EditOlderUserPositions extends StatefulWidget {
  final Person person;
  final String token;
  final int id;
  final List<AllPositions> positions;

  const EditOlderUserPositions(
      {Key key, this.person, this.token, this.id, this.positions})
      : super(key: key);

  @override
  _EditOlderUserPositionsState createState() => _EditOlderUserPositionsState();
}

class _EditOlderUserPositionsState extends State<EditOlderUserPositions> {
