...
class ShopAssignment extends StatefulWidget {
  final String token;
  ...
  const ShopAssignment(
      ...
      : super(key: key);
  @override
  _ShopAssignmentState createState() => _ShopAssignmentState();
}

class _ShopAssignmentState extends State<ShopAssignment> {
  @override
